...
class Form extends \Magento\Backend\Block\Widget\Form\Generic
{
    ...
    protected function _prepareForm()
    {
        ...
        if ($tmp[0]['quotation_status'] != 6) {
            ...
            $fieldset->addField('delivery_day', 'text', ['label' => __('Product should be delivered within these number of days after approval'),'title' => __('Delivery'),'disabled' => 'disabled','name' => 'delivery_day','required' => true,]);
            if($tmp[0]['delivery_date']){
                $fieldset->addField('delivery_date', 'text', ['label' => __('Expected delivery date'),'title' => __('Delivery'),'disabled' => 'disabled','name' => 'delivery_date','required' => true,]);
            }
            ...
            $fieldset->addField('comment', 'editor', ['name' => 'comment','label' => __('Comment'),'title' => __('Content'),'style' => 'height:36em','required' => true]);
