...
class InstallSchema implements InstallSchemaInterface
{
    ...
    public function install(SchemaSetupInterface $setup, ModuleContextInterface $context)
    {
        ...
        $sql = "CREATE TABLE `{$installer->getTable('b2b_quotation')}` (
          ...
          `quotation_status` enum('0','1','2','3','4','5','6','7','8') DEFAULT '7' 
          COMMENT '0->requested,1->approved,2->responded, 3->rejected, 4->re_requested, 5->accepted, 6->completed, 7->intermediate, 8->expired',
          `delivery_date` date DEFAULT NULL,
          `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
          `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
          `delivery_day` smallint(6) DEFAULT NULL,
          PRIMARY KEY (`id`),
