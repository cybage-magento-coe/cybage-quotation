...
class Expirequotation
{
    ...
    public function __construct(\Cybage\Quotation\Model\ResourceModel\Quotation\Collection $quotationCollection, \Cybage\Quotation\Helper\Data $helper, \Magento\Framework\Stdlib\DateTime\DateTime $date, \Psr\Log\LoggerInterface $logger
    )
    {
